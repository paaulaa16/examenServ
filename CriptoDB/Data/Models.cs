...
namespace Cripto.Models
{
    public class Cartera
    {
        ...
        // A implementar
        public override string ToString() => $"#{CarteraId} {Nombre} {Exchange} ({Contratos.Count} Contratos)";
    }
    public class Moneda
    {
        ...
        public List<Contrato> Contratos { get; } = new List<Contrato>();
        // A implementar
        public override string ToString() => $"#{MonedaId} {Actual} {Maximo} ({Contratos.Count} Contratos)";
    }
